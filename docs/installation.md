...
- [Running Rundsand in the Background with `screen` or `tmux`](#running-rundsand-in-the-background-with-screen-or-tmux)
...
|----------|-------------|-------------|---------|
| Linux x86_64 | AMD64 | `rundsand-linux-amd64` | `rundsand_*_amd64.deb` |
| Linux ARM64 | ARM64 | `rundsand-linux-arm64` | `rundsand_*_arm64.deb` |
| Linux ARMv7 | ARM32v7 | `rundsand-linux-armv7` | `rundsand_*_armhf.deb` |
...
4. Installs to `/usr/local/bin/rundsand`
...
[INFO] Version: v1.0.0
[INFO] Downloading: rundsand-linux-amd64
[SUCCESS] Installed Rundsand v1.0.0 to /usr/local/bin/rundsand
[INFO] Creating user directories...
[SUCCESS] Created user directories in /home/user/.config/rundsand
[SUCCESS] Installation complete! 🚀

🎉 Rundsand is now installed!

Next steps:
1. Run 'sudo rundsand --help' to see available commands
2. Run 'sudo rundsand' to start the interactive mode
...
LATEST_VERSION=$(curl -s https://api.github.com/repos/Soar-Development/rundsand-installer/releases/latest | grep -o '"tag_name": "[^"]*' | cut -d'"' -f4)
# Remove 'v' prefix for package naming
VERSION=${LATEST_VERSION#v}

# AMD64 (Intel/AMD 64-bit)
wget "https://github.com/Soar-Development/rundsand-installer/releases/download/${LATEST_VERSION}/rundsand_${VERSION}_amd64.deb"
sudo dpkg -i "rundsand_${VERSION}_amd64.deb"

# ARM64 (64-bit ARM)
wget "https://github.com/Soar-Development/rundsand-installer/releases/download/${LATEST_VERSION}/rundsand_${VERSION}_arm64.deb"
sudo dpkg -i "rundsand_${VERSION}_arm64.deb"

# ARMv7 (32-bit ARM)
wget "https://github.com/Soar-Development/rundsand-installer/releases/download/${LATEST_VERSION}/rundsand_${VERSION}_armhf.deb"
sudo dpkg -i "rundsand_${VERSION}_armhf.deb"
```
...
# AMD64
wget "https://github.com/Soar-Development/rundsand-installer/releases/download/${LATEST_VERSION}/rundsand-linux-amd64"

# ARM64
wget "https://github.com/Soar-Development/rundsand-installer/releases/download/${LATEST_VERSION}/rundsand-linux-arm64"

# ARMv7
wget "https://github.com/Soar-Development/rundsand-installer/releases/download/${LATEST_VERSION}/rundsand-linux-armv7"

# ARMv6
wget "https://github.com/Soar-Development/rundsand-installer/releases/download/${LATEST_VERSION}/rundsand-linux-armv6"
```

#### Install Binary
```bash
# Make executable
chmod +x rundsand-linux-*
...
mkdir -p ~/bin
mv rundsand-linux-amd64 ~/bin/rundsand
export PATH="$HOME/bin:$PATH"
```

#### Create User Directories
```bash
mkdir -p ~/.config/rundsand/wallets
```
...
1. **Start the CLI**: Run `sudo rundsand` to open the interactive menu
...
wget https://raw.githubusercontent.com/Soar-Development/rundsand-installer/main/install.sh
bash install.sh
...
```bash
# Download checksums
wget https://github.com/Soar-Development/rundsand-installer/releases/latest/download/checksums.txt
...
sudo dpkg -r rundsand
```

## Support

- **Documentation**: [GitHub Repository](https://github.com/Soar-Development/rundsand-installer)
- **Issues**: [Report Problems](https://github.com/Soar-Development/rundsand-installer/issues)
- **Releases**: [View Releases](https://github.com/Soar-Development/rundsand-installer/releases)
